...
const objectWithoutPropertiesLoose = require('./index.cjs109.js');
const inheritsLoose = require('./index.cjs110.js');
const index = require('./index.cjs111.js');
const React = require('react');
const ReactDOM = require('react-dom');
const config = require('./index.cjs116.js');
const PropTypes = require('./index.cjs114.js');
const TransitionGroupContext = require('./index.cjs117.js');
const reflow = require('./index.cjs115.js');
...
Transition.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  nodeRef: index.default.shape({
    current: typeof Element === 'undefined' ? index.default.any : function (propValue, key, componentName, location, propFullName, secret) {
      var value = propValue[key];
      return index.default.instanceOf(value && 'ownerDocument' in value ? value.ownerDocument.defaultView.Element : Element)(propValue, key, componentName, location, propFullName, secret);
    }
  }),
   ...
   * ```
   */
  children: index.default.oneOfType([index.default.func.isRequired, index.default.element.isRequired]).isRequired,
   ...
   */
  mountOnEnter: index.default.bool,

  /**
   * By default the child component stays mounted after it reaches the `'exited'` state.
   * Set `unmountOnExit` if you'd prefer to unmount the component after it finishes exiting.
   */
  unmountOnExit: index.default.bool,
