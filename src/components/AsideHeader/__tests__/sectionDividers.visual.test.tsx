...
for (const compact of [false, true]) {
    for (const quickAccess of [false, true]) {
        test(`section divider spacing: compact=${compact}, quickAccess=${quickAccess}`, async ({
            ...
            const initialPadding = await test.step('Default dividers and spacing', async () => {
            ...
            await test.step('Hide section dividers and preserve quick access', async () => {
            ...
            if (!compact) {
                await test.step('Scroll boundaries and stable content geometry', async () => {
                    const geometry = () =>
                        scroll.evaluate((el) => {
                            ...
                            return {
                                ...
                                first:
                                    rows[0]?.getBoundingClientRect().top - rect.top + el.scrollTop,
                                last:
                ...
                await test.step('Override and restore divider color', async () => {
                ...
                await test.step('Resize viewport to remove overflow', async () => {
            ...
            await test.step('Restore section dividers and spacing', async () => {
