...
| `hideCompactChevron`  | Если `true`, маленький шеврон не рендерится на якоре группы в компактном (свернутом) сайдбаре. Попап с дочерними пунктами продолжает работать как обычно.                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
