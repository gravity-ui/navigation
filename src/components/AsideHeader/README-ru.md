...
| hideSectionDividers            | Скрывает разделители Header/Footer (включая декоративный SVG свёрнутого Header) и отступы со стороны меню. Сохраняет фон Header, внешние отступы и разделители внутри меню/Quick Access. Также доступно в `PageLayoutAside` и `AsideFallback`.                         |                                                           `boolean`                                                           |          `false`          |
