...
| menuGroups                | Группы для организации элементов меню. Элементы с одинаковым `groupId` будут сгруппированы вместе.               |                                                      `Array<MenuGroup>`                                                       |                           |

### `MenuGroup`

| Имя     | Описание                            |    Тип    | Значение по умолчанию |
| :------ | :---------------------------------- | :-------: | :-------------------: |
| id      | Уникальный идентификатор группы     | `string`  |                       |
| title   | Заголовок группы (отображаемое имя) | `string`  |                       |
| order   | Порядок отображения группы          | `number`  |                       |
| visible | Видимость группы                    | `boolean` |        `true`         |
...
| groupId            | Идентификатор группы, к которой относится элемент меню. Используется для группировки элементов.                                 |                                                                `string`                                                                 |                             |
