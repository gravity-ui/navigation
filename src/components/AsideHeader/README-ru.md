...
`titleLines?: 1 | 2` задаёт максимальное число строк заголовка в развёрнутой панели. Если параметр
не задан, сохраняется прежнее ограничение в две строки. В компактной панели и popup всегда используется одна строка. Высота двухстрочной
строки учитывается в расчётах переполнения меню.
...
| titleLines             | Максимальное число строк заголовка в развёрнутой панели. В свёрнутой панели с иконками и popup всегда используется одна строка.                                                                     |                                                                       `1 \| 2`                                                                       |               `2`               |
