...
| `onItemClick`        | Опциональное основное действие заголовка группы (сигнатура как у `AsideHeaderItem.onItemClick`; получает синтетический пункт-заголовок группы). Если у группы есть собственное действие (`onItemClick` и/или `href`), то в инлайн-раскладке (`menuOverflow="scroll"`, развёрнутый сайдбар) клик по строке заголовка выполняет действие как у обычного пункта меню, а сворачивание/разворачивание происходит **только по шеврону**. Без собственного действия вся строка заголовка переключает группу, как раньше. |
