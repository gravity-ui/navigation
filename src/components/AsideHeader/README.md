...
| menuGroups                   | Group definitions (`id`, `title`, icon, optional `hidden`, `popupTitle`). Items attach via `AsideHeaderItem.groupId`.                                                                                         |                                                         `MenuGroup[]`                                                         |                           |
| defaultMenuItems             | Default list for resetting **All pages** edits                                                                                                                                                                |                                                   `Array<AsideHeaderItem>`                                                    |                           |
| menuOverflow                 | Overflow behavior for the composite menu: **`collapse`** (extra rows under «More», default) or **`scroll`** (inline scroll). Compact sidebar always behaves like **`collapse`**.                              |                                                   `'collapse' \| 'scroll'`                                                    |       `'collapse'`        |
