...
| hideSectionDividers            | Hides header/footer separators and spacing while preserving scroll-edge indicators. See [Section dividers](#section-dividers).                                                                                                     |                                                           `boolean`                                                           |          `false`          |
