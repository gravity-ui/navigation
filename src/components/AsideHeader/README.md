...
| menuGroups                | Groups for organizing menu items. Items with matching `groupId` will be grouped together |                                                      `Array<MenuGroup>`                                                       |                           |
...
| title   | Display title for the group     | `string`  |         |
| order   | Display order of the group      | `number`  |         |
| visible | Whether the group is visible    | `boolean` | `true`  |
