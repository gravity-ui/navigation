...
| hideSectionDividers            | Hides header/footer section separators (including the collapsed header decoration SVG) and their spacing toward the menu. Preserves header background, outer spacing, and separators inside menu/Quick Access. Also supported by `PageLayoutAside` and `AsideFallback`. |                                                           `boolean`                                                           |          `false`          |
...
| `--gn-aside-header-item-chevron-padding-right`            | Right padding of the chevron box in menu rows (group headers, flyouts)    |
| z-indexes                                                 |                                                                           |
