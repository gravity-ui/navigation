...
| collapseButtonWrapper     | Wrapper for `CollapseButton` allowing customization of the default button appearance | `(defaultButton: React.ReactNode, data: {pinned: boolean; onChangePinned?: (pinned: boolean) => void}) => React.ReactNode` |                           |
...
| pinned                 | When `true`, forces the item to display in expanded (pinned) form.                                                                                                                                                       |                                                                      `boolean`                                                                       |                                 |
